...
| Why `pages/index.tsx` is single-column without any `_app.tsx` change, why Categories "View all →" is hidden, or which static route is missing for `/categories` | [layout-system-gotchas.md](layout-system-gotchas.md) |

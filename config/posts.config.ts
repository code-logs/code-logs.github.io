...
,
  ...
  {
    title: `AI가 개발자의 시대를 끝낼까?`,
    description: `AI 코딩 도구가 개발자를 대체할 것이라는 주장에 대해 고용 전망과 생산성 연구를 바탕으로 개발자의 역할이 어떻게 달라지고 있는지 살펴본다.`,
    fileName: 'will-ai-replace-software-developers.md',
    category: '개발환경',
    published: true,
    publishedAt: `2026-06-07`,
    thumbnailName: `will-ai-replace-software-developers.webp`,
    tags: [
      `AI`,
      `Generative AI`,
      `Software Developer`,
    ...
    references: [
      { title: `Software Developers, Quality Assurance Analysts, and Testers`, url: `https://www.bls.gov/ooh/computer-and-information-technology/software-developers.htm` },
      { title: `Computer Programmers`, url: `https://www.bls.gov/ooh/computer-and-information-technology/computer-programmers.htm` },
      { title: `Occupational projections and worker characteristics, 2024–2034`, url: `https://www.bls.gov/emp/tables/occupational-projections-and-characteristics.htm` },
      { title: `Industry and occupational employment projections overview and highlights, 2024–34`, url: `https://www.bls.gov/opub/mlr/2026/article/industry-and-occupational-employment-projections-overview.htm` },
      { title: `The Future of Jobs Report 2025: Jobs outlook`, url: `https://www.weforum.org/publications/the-future-of-jobs-report-2025/in-full/2-jobs-outlook/` },
      { title: `Future of Jobs Report 2025 press release`, url: `https://www.weforum.org/press/2025/01/future-of-jobs-report-2025-78-million-new-job-opportunities-by-2030-but-urgent-upskilling-needed-to-prepare-workforces/` },
      { title: `One in four jobs at risk of being transformed by GenAI, new ILO–NASK Global Index shows`, url: `https://www.ilo.org/resource/news/one-four-jobs-risk-being-transformed-genai-new-ilo%E2%80%93nask-global-index-shows` },
      { title: `State of AI-assisted Software Development 2025`, url: `https://dora.dev/research/2025/dora-report/` },
      { title: `Research: quantifying GitHub Copilot’s impact on developer productivity and happiness`, url: `https://github.blog/news-insights/research/research-quantifying-github-copilots-impact-on-developer-productivity-and-happiness/` },
      { title: `Does GitHub Copilot improve code quality? Here’s what the data says`, url: `https://github.blog/news-insights/research/does-github-copilot-improve-code-quality-heres-what-the-data-says/` },
      ...
      { title: `We are Changing our Developer Productivity Experiment Design`, url: `https://metr.org/blog/2026-02-24-uplift-update/` },
      { title: `Anthropic Economic Index: AI’s impact on software development`, url: `https://www.anthropic.com/news/impact-software-development` },
      { title: `Anthropic Economic Index report: Economic primitives`, url: `https://www.anthropic.com/research/anthropic-economic-index-january-2026-report` },
      { title: `AI: 2025 Stack Overflow Developer Survey`, url: `https://survey.stackoverflow.co/2025/ai` },
    ],
  },
]
